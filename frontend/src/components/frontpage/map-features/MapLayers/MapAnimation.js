...
class MapAnimation extends Component {
  ...
  // const TruckAnimate = new TimelineMax({delay: 10, pause: true});
  //
  //
  ...
  //
  //
  // const PinBounce = new TimelineMax({repeat: -1, delay: 10});
  //
  ...
  //
  //
  // const PinAnimate = new TimelineMax({repeat: -1});
  //
  // PinAnimate.set(this.svg, {scale:1})
  //   .to(this.svg, 1, {scale:1.7, transformOrigin: '50% 50%', x:80, y: 50})
  //   .set(this.pin, {autoAlpha: 1})
  //   .to(this.svg, 1, {scale:1, transformOrigin: '50% 50%', x:0, y:100, delay: 5});
  //


    const PolygonAnimate = new TimelineMax({delay: 2});
    ...
    PolygonAnimate.set(this.pointer, {scale: 2, x: 100, y: 100})
      .to(this.svg, 2, {scale:1.7 })
      .to(this.pointer, 1, {x:this.bottomLeftCornerX, y:this.bottomLeftCornerY})
      .set(this.blc, {autoAlpha: 1, delay: 1}) // Make bottom left point visible
