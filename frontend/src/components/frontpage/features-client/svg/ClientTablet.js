...
class ClientTablet extends Component {
  render() {
    return (
      <Svg data-name="Lady" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 429.36 580.86">
        ...
        <path data-name="Neck Shadow" d="M197.75,321.47A11.66,11.66,0,0,0,187,334l1.23,16.22a35.32,35.32,0,0,0,23.26-1.76l-1.23-16.22A11.66,11.66,0,0,0,197.75,321.47Z" transform="translate(-99.64 -244.68)" fill="#f48989"/>
        <g>
