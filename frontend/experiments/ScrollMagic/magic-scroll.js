...
function scrollHandler() {
  ...
  if ((scrollPositionToParentDiv) >= window.scrollY) {
    ...
    Array.prototype.forEach.call(svgLayers, function (layer) {
      ...
      // for each "fill" pulls hsl out and removes quote-features.
  ...
  //       const hslComponents = layerFill.match(regex).slice(1); // Match to any hsl to "fill" and remove quote-features from hsl and place numbers in array
