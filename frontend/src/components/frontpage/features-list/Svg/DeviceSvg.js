  ...
  render() {
    return (
      <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 341 180.19">
        ...
        <g data-name="Desktop">
          <g data-name="desktop-2">
            <path data-name="body" d="M80.72,0h184a9.75,9.75,0,0,1,9.75,9.75V122.5a0,0,0,0,1,0,0H71a0,0,0,0,1,0,0V9.75A9.75,9.75,0,0,1,80.72,0Z"/>
            <circle data-name="camera" cx="172.72" cy="6.23" r="0.68" fill="#fff"/>
            <polygon data-name="stand" points="164.97 143.17 192.97 143.17 274.48 143.17 274.48 122.5 70.97 122.5 70.97 143.17 145.31 143.17 142.81 159.83 134.14 163.33 202.31 163.33 192.97 160.33 178.81 160.17 164.97 143.17" fill="#ccc"/>
            <polygon data-name="shadow" points="164.97 143.17 178.81 160.17 192.97 160.33 192.97 143.17 164.97 143.17" fill="#999"/>
          </g>
          <g data-name="screen">
        ...
        <g data-name="Tablet">
          <g data-name="body-2">
            <rect data-name="body-3" x="20.04" y="82.06" width="70" height="90.67" rx="5.67" ry="5.67"/>
            <circle data-name="button" cx="55.2" cy="167.31" r="2.84" fill="#fff"/>
            <circle data-name="camera-2" cx="55.04" cy="85.96" r="0.68" fill="#fff"/>
          </g>
          <g data-name="screen-2">
        ...
        <g data-name="Laptop" transform="translate(-50, 10)">
          <g data-name="laptop-2">
            <path data-name="screen_base" d="M242.14,72.67H364.59a3.94,3.94,0,0,1,3.94,3.94V158.5a0,0,0,0,1,0,0H238.2a0,0,0,0,1,0,0V76.61A3.94,3.94,0,0,1,242.14,72.67Z"/>
            <rect data-name="base" x="216.28" y="158.5" width="174.17" height="4.83" fill="#ccc"/>
            <polygon data-name="bottom_shadow" points="380.93 165.27 227.02 165.27 216.89 163.33 391.06 163.33 380.93 165.27" fill="#999"/>
            <path data-name="trackpad" d="M291.87,158.5h23a0,0,0,0,1,0,0v.86a.81.81,0,0,1-.81.81H292.68a.81.81,0,0,1-.81-.81v-.86A0,0,0,0,1,291.87,158.5Z" fill="#999"/>
            <circle data-name="camera-3" cx="303.98" cy="74.4" r="0.68" fill="#fff"/>
          </g>
          <g data-name="screen-3">
        ...
        <g data-name="Phone">
          <g id="phone-2">
            <rect data-name="body-4" y="111.07" width="34.88" height="69.12" rx="5.25" ry="5.25"/>
            <rect data-name="speaker" x="14.63" y="114.69" width="5.63" height="0.88" rx="0.24" ry="0.24" fill="#ccc"/>
            <circle data-name="button-2" cx="17.44" cy="175.82" r="2.84" fill="#fff"/>
            <circle data-name="camera-4" cx="12.78" cy="115.13" r="0.68" fill="#fff"/>
          </g>
          <g data-name="screen-4">
