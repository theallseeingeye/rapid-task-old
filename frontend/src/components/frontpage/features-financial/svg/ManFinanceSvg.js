  ...
  render() {
    return (
      <Svg data-name="Background" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 884.84 1000">
        ...
        <rect data-name="MediumMedium" x="8.42" y="-64.45" width="33.41" height="633.7" rx="16.7" ry="16.7" transform="translate(128.03 426.71) rotate(-135)" fill={this.color}/>
        <rect data-name="DarkMedium" x="55.17" y="-110.11" width="72.46" height="974.1" rx="36.23" ry="36.23" transform="translate(153.1 686.18) rotate(-135)" fill={this.color2}/>

        <rect data-name="trail" x="171.1" y="285.65" width="29.09" height="558.44" rx="13" ry="13" transform="translate(181.09 1073.63) rotate(-135)" fill="#fff" opacity="0.29"/>
        ...
        <rect data-name="trail-2" x="-37.51" y="249.75" width="27.94" height="442.68" rx="13" ry="13" transform="translate(-109.7 765.63) rotate(-135)" fill="#fff" opacity="0.29"/>
        ...
        <rect data-name="trail-3" x="221.77" y="173.43" width="48.65" height="441.73" rx="23" ry="23" transform="translate(404.9 825.19) rotate(-135)" fill="#fff" opacity="0.29"/>
        ...
        <rect data-name="trail-4" x="125.21" y="405.83" width="6.52" height="598.27" rx="2.18" ry="2.18" transform="translate(799.72 93.71) rotate(45)" fill="#fff" opacity="0.29"/>
        ...
        <rect data-name="trail-5" x="121.13" y="166.93" width="2" height="427.69" rx="0.95" ry="0.95" transform="translate(202.84 714.45) rotate(-135)" fill="#fff" opacity="0.29"/>
