...
class GraphAnimation extends Component {
  ...
  componentDidMount() {
    ...
    let random = Array.from({length: maxPosition + 5}, () => Math.floor(Math.random() * range)); // USE THIS FOR RANDOMIZER randomizer[1]
    ...
    chartDraw.to(this.polyline1, lineSpeed, {attr: {points: p[0].x + ", " + p[0].y + " " + p[0].x2 + ", " + p[0].y2}})  //segment 1
      .to(this.polyline1, lineSpeed, {attr: {points: p[1].x + ", " + p[1].y + " " + p[1].x2 + ", " + p[1].y2}})
      ...
      .to(this.polyline1, barSpeed, {strokeWidth: (300 - random[0]), y: ((300 - random[0]) / 2)})
      .to(this.polyline2, barSpeed, {autoAlpha: 0})
      .to(this.polyline3, barSpeed, {strokeWidth: (300 - random[1]), y: ((300 - random[1]) / 2)})
      .to(this.polyline4, barSpeed, {autoAlpha: 0})
      .to(this.polyline5, barSpeed, {strokeWidth: (300 - random[2]), y: ((300 - random[2]) / 2)})
      .to(this.polyline6, barSpeed, {autoAlpha: 0})
      .to(this.polyline7, barSpeed, {strokeWidth: (300 - random[3]), y: ((300 - random[3]) / 2)})
      .to(this.polyline8, barSpeed, {autoAlpha: 0})
      .to(this.polyline9, barSpeed, {strokeWidth: (300 - random[4]), y: ((300 - random[4]) / 2)})
      .to(this.polyline10, barSpeed, {autoAlpha: 0})
      .to(this.polyline11, barSpeed, {strokeWidth: (300 - random[5]), y: ((300 - random[5]) / 2)})
      .to(this.polyline12, barSpeed, {autoAlpha: 0})
      .to(this.polyline13, barSpeed, {strokeWidth: (300 - random[6]), y: ((300 - random[6]) / 2)})
      .to(this.polyline14, barSpeed, {autoAlpha: 0})
      .to(this.polyline15, barSpeed, {strokeWidth: (300 - random[7]), y: ((300 - random[7]) / 2)})
      .to(this.polyline16, barSpeed, {autoAlpha: 0})
      .to(this.polyline17, barSpeed, {strokeWidth: (300 - random[8]), y: ((300 - random[8]) / 2)})
      .to(this.polyline18, barSpeed, {autoAlpha: 0})
      .to(this.polyline19, barSpeed, {strokeWidth: (300 - random[9]), y: ((300 - random[9]) / 2)})
      .to(this.polyline20, barSpeed, {autoAlpha: 0})
      .to(this.polyline21, barSpeed, {strokeWidth: (300 - random[10]), y: ((300 - random[10]) / 2)})
      .to(this.polyline22, barSpeed, {autoAlpha: 0})
      .to(this.polyline23, barSpeed, {strokeWidth: (300 - random[11]), y: ((300 - random[11]) / 2)})
      .to(this.polyline24, barSpeed, {autoAlpha: 0})
      .to(this.polyline25, barSpeed, {strokeWidth: (300 - random[12]), y: ((300 - random[12]) / 2)})
      .to(this.polyline26, barSpeed, {autoAlpha: 0})
      .to(this.polyline27, barSpeed, {strokeWidth: (300 - random[13]), y: ((300 - random[13]) / 2)})
      .to(this.polyline28, barSpeed, {autoAlpha: 0})
      .to(this.polyline29, barSpeed, {strokeWidth: (300 - random[14]), y: ((300 - random[14]) / 2)})
      .to(this.polyline30, barSpeed, {autoAlpha: 0})
      .to(this.polyline31, barSpeed, {strokeWidth: (300 - random[15]), y: ((300 - random[15]) / 2)})
      .to(this.polyline32, barSpeed, {autoAlpha: 0})
      .to(this.polyline33, barSpeed, {strokeWidth: (300 - random[16]), y: ((300 - random[16]) / 2)})
      .to(this.polyline34, barSpeed, {autoAlpha: 0})
      .to(this.polyline35, barSpeed, {strokeWidth: (300 - random[17]), y: ((300 - random[17]) / 2)})
      .to(this.polyline36, barSpeed, {autoAlpha: 0})
      .to(this.polyline37, barSpeed, {strokeWidth: (300 - random[18]), y: ((300 - random[18]) / 2)})
      .to(this.polyline38, barSpeed, {autoAlpha: 0})
      .to(this.polyline39, barSpeed, {strokeWidth: (300 - random[19]), y: ((300 - random[19]) / 2)})
      .to(this.polyline40, barSpeed, {autoAlpha: 0})

      // Erases out all the remainder polylines that are still visible.
      .to(this.polyline1, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline3, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline5, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline7, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline9, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline11, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline13, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline15, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline17, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline19, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline21, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline23, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline25, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline27, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline29, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline31, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline33, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline35, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline37, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0})
      .to(this.polyline39, barSpeed / 2, {strokeWidth: 0, autoAlpha: 0});
  ...
  render() {
    ...
    return (
      <Div>
        <Svg innerRef={x => this.svg = x} viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">

          {/*<PolyList/>*/}

          <Polyline innerRef={x => this.polyline1 = x}/>
          <Polyline innerRef={x => this.polyline2 = x}/>
          <Polyline innerRef={x => this.polyline3 = x}/>
          <Polyline innerRef={x => this.polyline4 = x}/>
          <Polyline innerRef={x => this.polyline5 = x}/>
          <Polyline innerRef={x => this.polyline6 = x}/>
          <Polyline innerRef={x => this.polyline7 = x}/>
          <Polyline innerRef={x => this.polyline8 = x}/>
          <Polyline innerRef={x => this.polyline9 = x}/>
          <Polyline innerRef={x => this.polyline10 = x}/>
          <Polyline innerRef={x => this.polyline11 = x}/>
          <Polyline innerRef={x => this.polyline12 = x}/>
          <Polyline innerRef={x => this.polyline13 = x}/>
          <Polyline innerRef={x => this.polyline14 = x}/>
          <Polyline innerRef={x => this.polyline15 = x}/>
          <Polyline innerRef={x => this.polyline16 = x}/>
          <Polyline innerRef={x => this.polyline17 = x}/>
          <Polyline innerRef={x => this.polyline18 = x}/>
          <Polyline innerRef={x => this.polyline19 = x}/>
          <Polyline innerRef={x => this.polyline20 = x}/>
          <Polyline innerRef={x => this.polyline21 = x}/>
          <Polyline innerRef={x => this.polyline22 = x}/>
          <Polyline innerRef={x => this.polyline23 = x}/>
          <Polyline innerRef={x => this.polyline24 = x}/>
          <Polyline innerRef={x => this.polyline25 = x}/>
          <Polyline innerRef={x => this.polyline26 = x}/>
          <Polyline innerRef={x => this.polyline27 = x}/>
          <Polyline innerRef={x => this.polyline28 = x}/>
          <Polyline innerRef={x => this.polyline29 = x}/>
          <Polyline innerRef={x => this.polyline30 = x}/>
          <Polyline innerRef={x => this.polyline31 = x}/>
          <Polyline innerRef={x => this.polyline32 = x}/>
          <Polyline innerRef={x => this.polyline33 = x}/>
          <Polyline innerRef={x => this.polyline34 = x}/>
          <Polyline innerRef={x => this.polyline35 = x}/>
          <Polyline innerRef={x => this.polyline36 = x}/>
          <Polyline innerRef={x => this.polyline37 = x}/>
          <Polyline innerRef={x => this.polyline38 = x}/>
          <Polyline innerRef={x => this.polyline39 = x}/>
          <Polyline innerRef={x => this.polyline40 = x}/>
        </Svg>
      </Div>
    )
  }
